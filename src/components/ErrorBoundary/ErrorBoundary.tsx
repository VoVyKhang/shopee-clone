    ...
    if (this.state.hasError) {
      ...
      return (
        <main className='h-screen w-full flex flex-col justify-center items-center '>
          ...
          <div className='bg-orange px-2 text-sm text-white rounded rotate-12 absolute'>Error!</div>
          ...
          <button className='mt-5'>
            ...
            >
              <span className='absolute inset-0 transition-transform translate-x-0.5 translate-y-0.5 bg-orange group-hover:translate-y-0 group-hover:translate-x-0'></span>
